...
export default function Landing({ session }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await axios.post(`/api/messaging/contactForm`, { firstName: firstNameInput, lastName: lastNameInput, email: email, message, role }, config).then(function (response) {

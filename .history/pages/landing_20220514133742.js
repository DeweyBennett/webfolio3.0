...
export default function Landing({ session }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await axios.post(`/api/messaging/contactForm`, { firstName: firstNameInput, lastName: lastNameInput, email: emailInput, message: message, role }, config).then(function (response) {

...
export default function Tables({ session }) {
  ...
  console.log("Blogs", BlogsBlogsoadError)
  console.log("PortProjectsData", PortProjectsLoadError)
  console.log("Leads", LeadsLoadError)
  console.log("Deals", DealsLoadError)

...
export default function NewBlog({ session }) {
  ...
  const validationSchema = yup.object().shape({
    Blog_Title: yup.string().required().max().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    ...
    Sect1_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect1_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect2_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect2_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect3_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect3_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect4_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect4_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect5_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect5_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect6_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect6_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect7_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect7_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect8_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect8_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect9_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect9_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect10_Heading: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/),
    Sect10_Body: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/)
  })

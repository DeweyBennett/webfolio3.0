...
export default function NewBlog({ session }) {
  ...
  const submitValidData = async (d) => {
    ...
    const data = await axios.post(`/api/blog`, { title: titleInput, author: authorInput, tags, sect1_head: sect1_headInput, sect1_body: sect1_bodyInput, sect2_head: sect2_headInput, sect2_body, sect3_head, sect3_body, sect4_head, sect4_body, sect5_head, sect5_body, sect6_head, sect6_body, sect7_head, sect7_body, sect8_head, sect8_body, sect9_head, sect9_body, sect10_head, sect10_body, }, config).then(function (response) {

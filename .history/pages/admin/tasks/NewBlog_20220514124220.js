...
export default function NewBlog({ session }) {
  ...
  const validationSchema = yup.object().shape({
    Blog_Title: yup.string().required().matches(/[\w][^<>="'?&$]/),
    Blog_Author: yup.string().required().matches(/[\w][^<>="'?&$]/),
    Blog_tags: yup.string().required().matches(/[\w][^<>="'?&$]/),
    Sect1_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect1_Body: yup.string().required().matches(/[\w][^<>="'?&$]/),
    Sect2_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect2_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect3_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect3_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect4_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect4_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect5_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect5_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect6_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect6_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect7_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect7_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect8_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect8_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect9_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect9_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect10_Heading: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true }),
    Sect10_Body: yup.string().matches(/[\w][^<>="'?&$]/, { excludeEmptyString: true })
  })

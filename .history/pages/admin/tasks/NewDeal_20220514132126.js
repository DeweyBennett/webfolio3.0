...
export default function NewDeal({ session }) {
  ...
  const validationSchema = yup.object().shape({
    ...
    Last_Name: yup.string().required().min(8).matches(/[\w][^<>="'?&$]/),
    Organization: yup.string().required().matches(/[\w][^<>="'?&$]/),
    Email: yup.string().required().email().matches(/[\w][^<>="'?&$]/),
    Dev_Costs: yup.string().required().matches(/[\w][^<>="'?&$]/),
    Monthly_Cost: yup.string().required().matches(/[\w][^<>="'?&$]/),
    Project_Manager: yup.string().required().matches(/[\w][^>="'?&$]/),
    Project_Name: yup.string().required().matches(/[\w][^<>="'?&$]/),
    Project_Details: yup.string().required().matches(/[\w][^<>="'?&$]/),
  })
                ...
                <div className="flex flex-wrap">
                  ...
                  <div className="w-full lg:w-6/12 px-4">
                    ...
                    <label
                      ...
                      {errors.Project_Name &&
                      <div className="text-red-600 font-semibold">
                        <span>Project Name is invalid</span>
                      </div>
                      }
                    </div>
                  </div>
                  ...
                  <div className="w-full lg:w-12/12 px-4">
                    <div className="relative w-full mb-3">
                      ...
                      <textarea
                        ...
                        onChange={(e) => setprojectDetailsInput(e.target.value)}
                      ></textarea>
                      {errors.Project_Details &&
                      <div className="text-red-600 font-semibold">
                        <span>Project details are invalid</span>
                      </div>
                      }
                    </div>
                  </div>

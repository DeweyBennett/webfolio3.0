...
export default function NewContact({ session }) {
  ...
  const handleSubmit = async () => {
    ...
    const data = await axios.post(`/api/auth/register`, { firstName: firstName, lastName, organization, jobTitle, email, phoneNumber, streetAddress, city, state, zipCode, role, notes }, config).then(function (response) {

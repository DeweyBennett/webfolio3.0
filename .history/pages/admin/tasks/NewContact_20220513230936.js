...
export default function NewContact({ session }) {
  ...
  const [streetAddressInput, setStreetAddress] = useState("");
  ...
  const handleSubmit = async () => {
    ...
    const data = await axios.post(`/api/auth/register`, { firstName: firstNameInput, lastName: lastNameInput, organization: organizationInput, jobTitle: jobTitleInput, email: emailInput, phoneNumber: phoneNumberInput, streetAddress, city, state, zipCode, role, notes }, config).then(function (response) {

...
export default function NewContact({ session }) {
  ...
  const handleSubmit = async () => {
    ...
    const data = await axios.post(`/api/auth/register`, { firstName: firstNameInput, lastName: lastNameInput, organization: organizationInput, jobTitle: jobTitleInput, email: emailInput, phoneNumber: phoneNumberInput, streetAddress: streetAddressInput, city: cityInput, state: stateInput, zipCode: zipCodeInput, role, notes: notes }, config).then(function (response) {

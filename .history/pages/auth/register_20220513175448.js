...
export default function Register({ session }) {
  ...
  const validationSchema = yup.object().shape({
    ...
    Last_Name: yup.string().required().matches(/[\w][^script | img | onError | src][^<>="'?&$]/, 'First name is invalid'),
    Organization: yup.string().matches(/[\w][^script | img | onError | src][^<>="'?&$]/, 'First name is invalid'),

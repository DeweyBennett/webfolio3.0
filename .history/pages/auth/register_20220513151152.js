...
export default function Register({ session }) {
  ...
  const handleSubmit = async () => {
    ...
    const data = await axios.post(`/api/auth/register`, { firstName: firstNameInput, lastName: lastNameInput, organization: organizationInput, jobTitle: jobTitleInput, email: emailInput, phoneNumber: phoneNumberInput, streetAddress: streetAddressInput, city: cityInput, state: state, zipCode, password, role }, config).then(function (response) {

...
export default function Register({ session }) {
  ...
  const validationSchema = yup.object().shape({
    First_Name: yup.string().required().min(8),
    Last_Name: yup.string().required().min(8),
    Organization: yup.string().required().min(8),
    Job_Title: yup.string().required().min(8),
    Email: yup.string().required().min(8),
    Phone_Number: yup.string().required().min(8),
    Street_Address: yup.string().required().min(8),
    City: yup.string().required().min(8),
    StrStateeet_Address: yup.string().required().min(8),
    Street_Address: yup.string().required().min(8),
  })

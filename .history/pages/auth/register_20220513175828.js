...
export default function Register({ session }) {
  ...
  const validationSchema = yup.object().shape({
    ...
    Password: yup.string().required().min(8, 'Password must be a minimum of 8 characters').max(12, 'Password must be a max of 8 characters').matches(/[\w][^script | img | onError | src][^<>="'?&$]/, 'Password is invalid'),
  })

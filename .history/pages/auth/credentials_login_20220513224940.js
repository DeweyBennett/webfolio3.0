              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form onSubmit={handleSubmit(submitValidData)}>
                  ...
                  <div className="text-center mt-6">
                    <button
                      className="text-[#d9dce1] px-2 py-4 w-[50%] mx-auto mt-4 rounded-full text-lg font-bold bg-gradient-to-r from-[#AE67FA] to-[#F49867] hover:bg-gradient-to-l hover:from-[#AE67FA] hover:to-[#F49867]"
                      type="submit"
                    >
                      Submit
                    </button>

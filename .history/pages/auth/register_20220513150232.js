...
export default function Register({ session }) {
  ...
  const handleSubmit = async () => {
    ...
    const data = await axios.post(`/api/auth/register`, { firstName: firstNameInput, lastName: lastName, organization, jobTitle, email, phoneNumber, streetAddress, city, state, zipCode, password, role }, config).then(function (response) {

...
export default function BlogPost({ session, id }){
    const { data: Blog, error:BlogLoadError } = useSWR(`http://localhost:3000/api/blog/${id}`, fetcher)
...
export async function getServerSideProps(context, {pra}) {

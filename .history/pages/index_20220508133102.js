...
const BlogFetcher = async () => {
  ...
  console.log("PortfolioFetcher", PortfolioFetcher)
  return data
}
...
const PortfolioFetcher = async () => {
  ...
  const data = await res.json()
  console.log("PortfolioFetcher console.log("PortfolioFetcher", PortfolioFetcher)", PortfolioFetcher)
  return data
}
...
export default function Home({ session, allBlogs, portProjects }) {
  ...
  const { data: Blogs, error: BlogsLoadError } = useSWR('blogData', BlogFetcher)

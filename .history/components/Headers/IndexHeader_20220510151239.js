                ...
                <div className="grid grid-cols-2 gap-14 items-center min-h-[100vh] max-w-[80%] mx-auto">
                    <div className="text-left col-span-1">
                        ...
                        <div className='flex flex-col w-[100%]'>
                            <button onClick={() => router.push('/landing')} className='text-white px-2 py-4 w-[50%] mx-auto mt-4 rounded-full text-lg font-bold bg-gradient-to-r from-[#AE67FA] to-[#F49867] hover:bg-gradient-to-l hover:from-[#AE67FA] hover:to-[#F49867]'>Send Message</button>
                        </div>
                    </div>

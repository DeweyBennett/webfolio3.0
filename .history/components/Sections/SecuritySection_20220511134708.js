    ...
    return (
        <div className='bg-gradient-to-br from-[#00131c] to-[#000000] w-11/12 mx-auto'>
            ...
            <div className="text-white w-[75%] mx-auto my-8">
                ...
                <p className="text-lg text-gray-400 py-8">White hat security is using the latest techniques used by malicious hackers to search out vulneralbilities within your website, computer systems</p>
            </div>
        </div>
    )
}